        ...
        <div class="row">
            ...
            <div class='row'>
                ...
                <h2 style="text-align:left;">1.Staat alle relevante week voor de desbetreffende week in de database?</h2>
                    ...
                    <td>@if(in_array($i,$reminderweeks))<div class='btn btn-primary' disabled>Reminder verstuurd</div>@elseif(in_array($i,$allweeks))<a href='/sendreminder?week={{$i}}'><div class='btn btn-primary btn-reminder'>Verstuur reminder</div></a>@else<div class='btn btn-primary' disabled>Verstuur reminder</div>@endif</td>
